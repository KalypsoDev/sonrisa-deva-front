      ...
      <section className="bg-backgroundBlue">
        <div className="container mx-auto p-4">
          ...
          <div className="flex flex-col">
            <div className="mb-4">
                <p className="text-base md:text-lg font-montserratRegular text-left">A través de este sitio web no se recaban datos de carácter personal de los usuarios sin su conocimiento, ni se ceden a terceros.</p>
            </div>

            <div className="mb-4">
                <p className="text-base md:text-lg font-montserratRegular text-left">El portal del que es titular La Sonrisa de Deva contiene enlaces a sitios web de terceros, cuyas políticas de privacidad son ajenas a la Asociación. Al acceder a tales sitios web usted puede decidir si acepta sus políticas de privacidad y de cookies.</p>
            </div>

            <div className="mb-4">
                <p className="text-base md:text-lg font-montserratRegular text-left">Con carácter general, si navega por internet usted puede aceptar o rechazar las cookies de terceros desde las opciones de configuración de su navegador.</p>
            </div>

            <div className="mb-4">
                <h2 className="text-lg md:text-xl font-montserratBold text-left mb-2"> ¿Quién es el responsable del tratamiento de los datos?</h2>
            ...
            <div className="mb-4">
                <h2 className="text-lg md:text-xl font-montserratBold text-left mb-2"> ¿Cuál es la legitimación para el tratamiento de sus datos?</h2>
                <p className="text-base md:text-lg font-montserratRegular text-left">
            ...
            <div className="mb-4">
                <h2 className="text-lg md:text-xl font-montserratBold text-left mb-2"> ¿Por cuánto tiempo conservaremos sus datos personales?</h2>
                <p className="text-base md:text-lg font-montserratRegular text-left">
            ...
            <div className="mb-4">
                <h2 className="text-lg md:text-xl font-montserratBold text-left mb-2"> ¿Qué tipo de información recolectamos?</h2>
                <p className="text-base md:text-lg font-montserratRegular text-left">
            ...
            <div className="mb-4">
                <h2 className="text-lg md:text-xl font-montserratBold text-left mb-2"> ¿Cómo recopilamos información?</h2>
                <p className="text-base md:text-lg font-montserratRegular text-left">
            ...
            <div className="mb-4">
                <p className="text-base md:text-lg font-montserratRegular text-left">Los titulares de los datos personales obtenidos, podrán ejercer sus derechos de protección de datos personales dirigiendo una comunicación por escrito al correo electrónico habilitado a tal efecto, lasonrisadedeva@gmail.com</p>
            </div>

            <div className="mb-4">
                <h2 className="text-lg md:text-xl font-montserratBold text-left mb-2"> Reclamaciones ante las autoridades de protección de datos</h2>
                <p className="text-base md:text-lg font-montserratRegular text-left">
            ...
            <div className="mb-4">
                <h2 className="text-lg md:text-xl font-montserratBold text-left mb-2"> ¿Cómo nos comunicamos con vosotros?</h2>
                <p className="text-base md:text-lg font-montserratRegular text-left">
            ...
            <div className="mb-4">
                <h2 className="text-lg md:text-xl font-montserratBold text-left mb-2"> ¿Cómo pueden los visitantes retirar su consentimiento?</h2>
                <p className="text-base md:text-lg font-montserratRegular text-left">
            ...
            <div className="mb-4">
                <h2 className="text-lg md:text-xl font-montserratBold text-left mb-2"> Actualizaciones de política de privacidad</h2>
                <p className="text-base md:text-lg font-montserratRegular text-left">
