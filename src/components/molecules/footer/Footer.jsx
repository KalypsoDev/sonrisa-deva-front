...
const Footer = () => {
  return (
    <footer className="bg-white relative pt-4 pb-4 drop-shadow-[0-6px_6px_rgba(0,130,202,0.3)]">
      <div className="container flex flex-row justify-between max-w-screen-xl mx-auto">
        <div className="flex flex-col text-center justify-evenly justify-items-center">
