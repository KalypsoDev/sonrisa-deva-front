      ...
      <section className='bg-backgroundBlue relative'>
        ...
        <div className="flex justify-items-center">
          <div className="flex flex-wrap md:flex-row md:justify-center">
            ...
            <div className="w-full md:w-1/2 flex justify-start relative mb-56 md:mb-0 text-end">
              <AssociationCard
                ...
                description={[
                  ...
                  <span><strong>3.</strong> <strong>Financiar</strong> el acceso a <strong> terapias y/o aparatos ortoprotésicos</strong> que ayuden a mejorar la calidad de vida de Deva y/o otros niños en su situación.</span>,
            ...
            <img src="src\assets\img\asociacion-deva.png" alt="Imagen Deva" className="border-4 border-primaryBlue rounded-full h-52 w-52 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10" />
            ...
            <div className="w-full md:w-1/2 flex justify-start relative text-center">
              <AssociationCard
                icon={<FaCalendarAlt className='text-6xl text-primaryBlue' />}
                title="Actividades"
                description={[
                  <span><strong>1.</strong> <strong>Difusión</strong> de las características del síndrome, evolución de la investigación científica y peculiaridades de Deva en redes sociales y medios de comunicación.</span>,
                  <span><strong>2.</strong> Organización de <strong>eventos solidarios.</strong></span>,
                  <span><strong>3.</strong> <strong>Cooperación y colaboración</strong> con diversas entidades sin ánimo de lucro en el cumplimiento de sus fines (Fundación Fast España, Asociación Síndrome de Angelman España, y otras con fines similares y principios compatibles con los de LA SONRISA DE DEVA).</span>
                ]}
              />
            </div>
          </div>
