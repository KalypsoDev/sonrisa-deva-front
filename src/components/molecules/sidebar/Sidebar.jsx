                ...
                <div className="h-full px-2 py-3 overflow-y-auto bg-primaryLila">
                    ...
                    <div className="flex justify-center">
                        <Button
                            ...
                            className="text-white font-montserratBold text-sm bg-darkBlue focus:ring-4 focus:ring-blue-300 rounded-lg px-5 py-2.5 me-2 mb-2 mt-2 focus:outline-none"
                            text="Cerrar sesión"
                        />
                    </div>
                </div>
