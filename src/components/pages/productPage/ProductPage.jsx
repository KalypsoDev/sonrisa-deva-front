    ...
    <>
      ...
      <div className="bg-backgroundBlue">
        <div className="container mx-auto py-8">
          <h1 className="text-3xl font-bold text-center text-white mb-8">Tienda Solidaria</h1>
          <p className="text-lg text-white mb-8">
            Puedes colaborar realizando un donativo a cambio de nuestros productos solidarios. Rellena el formulario para
            realizar el pedido y nos pondremos en contacto contigo para indicarte las opciones de pago.
          </p>
